...
describe('ReceiptAuthorizationService', () => {
  ...
  let store: ReceiptAuthorizationStore;
  ...
  beforeEach(() => {
    ...
    store = TestBed.inject(ReceiptAuthorizationStore);
  });
  ...
  describe('#get', () => {
    it('should call get method of base service', () => {
      const url = `${environment.apiUrl}/cats_core/dispatches/1/receipt_authorizations`;
  ...
  describe('#add', () => {
    let payload: ReceiptAuthorization;
    beforeEach(() => {
      payload = {
        id: null,  
        store_id: 1,
